...
const ProfileDetails = ({ className,userData,addProduct,...rest }) => {
  ...
  const {values,errors,handleChange,handleSubmit,acceptedFiles,acceptedFilesItems,getRootProps,getInputProps,onLoadVideoMetaData,videoFile,metadata,storeVideoMetaData}=useForm(validateInfo,userData,addProduct)
    ...
    >
      ...
      {videoFile && (
        <video
          controls={true}
          width="250"
          onLoadedMetadata={onLoadVideoMetaData}
        >
        ...
        <CardContent>
          ...
          >
            ...
            >
              <TextField
                fullWidth
                helperText="Please specify the Product Description"
                label="Description"
                name="description"
                onChange={handleChange}
                required
...
const mapDispatchToProps=dispatch=>({
  addProduct:(collection,userId,imageInfo,videoFile)=>dispatch(ProductCollectionsAddStart(collection,userId,imageInfo,videoFile))
});
